...
const Header: FC = () => {
  ...
  }, [isOpen, topLineAnimate, bottomLineAnimate, topLineScope, bottomLineScope, navScope, navAnimate]);

  const handleClickMobileNavItem = (e: React.MouseEvent<HTMLAnchorElement>) => { //! i added this
    e.preventDefault();
    setIsOpen(false);
      ...
      <div className="fixed top-0 left-0 w-full mix-blend-difference backdrop-blur-md z-10">
        <div className="container !max-w-full">
          <div className="flex justify-between h-20 items-center">
            <div>
              <a href="/">
                <span className="text-xl font-bold uppercase text-white">Suraj&nbsp; Adde</span>
              </a>
            </div>
          </div>
        </div>
...
//? 53:05 --> video completion time (part 2)