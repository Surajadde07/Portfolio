...
const testimonials = [
  {
    ...
    role: "Head of Design",
    quote:
      "Suraj expertise in both technical development and design created a beautiful, high-performing website.",
    image: image1,
    imagePositionY: 0.2,
  },
  {
    ...
    role: "Founder",
    quote:
      "Suraj transformed our boutique coffee brand with a website that perfectly balances aesthetics and functionality.",
    image: image2,
    imagePositionY: 0.1,
  },
  {
    ...
    quote:
      "The collaborative process was amazing. Suraj brought lots of fresh perspectives and innovative solutions.",
    image: image3,
    imagePositionY: 0.55,
  },
];
...
const Testimonials: FC = () => {
  ...
  return <section className="section" id="testimonials">
    <h2 className="text-4xl md:text-7xl lg:text-8xl flex flex-col overflow-hidden" ref={titleRef}>
      ...
      >Some nice words form my past clients</motion.span>
...
// 01:28:01 --> video completion time